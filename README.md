...
- 例: print n, "個見つかった" （n が 3 のとき，「3 個見つかった」と表示されます。）
...
- 例: val = 7 / 2 　 （atai には 3.5 が代入されます。）
- 例: quo = 7 // 2 　 （syo には 3 が代入されます。）
- 例: remain = 10 % 3 （amari には 1 が代入されます。）
...
- 例: n > 3 （n が 3 より大きければ真となります。）
- 例: n * 2 <= 8 （n の 2 倍が 8 以下であれば真となります。）
- 例: n != 0 （n が 0 でなければ真となります。）
...
- 例: n >= 12 and n <= 27 （n が 12 以上 27 以下なら真となります。）
- 例: n % 2 == 0 or n < 0 （n が偶数か負の値なら真となります。）
- 例: not n > 75 （n が 75 より大きくなければ真となります。）
- 例: n > 12 and not n < 27 でない は，n > 12 and (not n < 27) と同じです。
- 例: not n > 12 and n < 27 でない は，(not n > 12) and n < 27 と同じです。
